        ...
        <div className="flex-1 overflow-auto pl-4 pr-5 pb-5">
          {filteredList.length === 0 && (
            <div className="pl-2 text-bolt-elements-textTertiary">
              {list.length === 0 ? 'No hay conversaciones recientes' : 'No se encontraron coincidencias'}
            </div>
          )}
          <DialogRoot open={dialogContent !== null}>
            ...
            <Dialog onBackdrop={closeDialog} onClose={closeDialog}>
              {dialogContent?.type === 'delete' && (
                <>
                  <DialogTitle>¿Borrar chat?</DialogTitle>
                  <DialogDescription asChild>
                    <div>
                      <p>
                        Esta a punto de borrar <strong>{dialogContent.item.description}</strong>.
                      </p>
                      <p className="mt-1">¿Esta seguro/a que desea borrar este chat?</p>
                    </div>
                  </DialogDescription>
